...
print("Here is the anxious scenario")

a = agent.agent(anxious_mdp())
a.train(10000)
...
with open(MODEL_RESULT_FILE,'w') as new_file:
    ...
    thewriter.writerow(['Anxiety',a.sud_app,a.goal_app,a.cdc_app,a.power_app,a.appraise_responsibility()])
    new_file.close()
# %%
