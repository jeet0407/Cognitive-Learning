...
class rage_mdp():
    def __init__(self):
        self.permitted_states = ['S','P','S1','E','G']
...
print("Here is the rage scenario")

a = agent.agent(rage_mdp())
a.train(30000)
a.simulate_episode(terminate = "P")

with open(MODEL_RESULT_FILE,'a',newline='') as new_file:
    thewriter = csv.writer(new_file)
    thewriter.writerow(['Rage',a.sud_app,a.goal_app,a.cdc_app,a.power_app,a.appraise_responsibility()])
    new_file.close()  
# %%
