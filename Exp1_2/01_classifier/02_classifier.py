...
def generate_sample_data(n=None, filename=None):
    emotions = {
        'Boredom': ['very_low', 'low', 'open', 'medium', 'low_urgency', 'low_effort'],
        'Fear': ['high', 'high', 'obstruct', 'very_low', 'high_urgency', 'medium_effort'],
        'Happiness': ['low', 'medium', 'high', 'open', 'low_urgency', 'low_effort'],
        'Joy': ['high', 'high', 'very_high', 'open', 'low_urgency', 'low_effort'],
        'Pride': ['open', 'high', 'high', 'open', 'medium_urgency', 'high_effort'],
        'Sadness': ['low', 'high', 'obstruct', 'very_low', 'medium_urgency', 'medium_effort'],
        'Shame': ['open', 'high', 'open', 'open', 'medium_urgency', 'high_effort']
    }
