...
# Load Human Data
# ---------------------------
data = pd.read_csv(os.path.join(exp_root, "data", "human_free.csv"), sep=";")
...
# Model Data
# ---------------------------
data_m = pd.read_csv(os.path.join(exp_root, "data", "svm_free_0.0032_var.csv"))
...
plt.tight_layout()
plt.savefig(os.path.join(exp_root, "plots", "exp1_free.png"), dpi=300)
...
plt.xlim(0, 0.5)
plt.ylim(0, 0.5)
plt.savefig(os.path.join(exp_root, "plots", "scatter.png"))